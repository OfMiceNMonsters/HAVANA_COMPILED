...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2018 at 07:12 AM
...
INSERT INTO `usersandemail` (`user_id`, `user_firstname`, `user_lastname`, `username`, `user_email`, `user_password`, `email_verified`, `token`, `role`) VALUES
...
(27, 'KHAIRUBI', 'SKADARISMAN', 'ayylol', 'MuhdTajuddin_AKhalim@Singaporeair.com.sg', '$2y$10$M2eGd0.HLCfPhcbjJdxvD.oW0dgmu/AtHQk6MjO1jdUlZFWFRKgxy', 0, 'iadxzkoclsgeumzbphftvrwynjq', ''),
(28, 'ooook', 'oook', 'oook', 'oook@gmail.com', '$2y$10$1IAGlX7GqEt9EDQl8zbokuD4jJmeegiaktgfhfLYoSbOkXly8oS3.', 0, 'avztblgrifndehumwjczqxospky', 'admin'),
(29, 'tam', 'tam', 'tam', 'tam@gmail.com', '$2y$10$E8Zbkjqn24o2kfZOfCKQfeVkBgukTDfCaApe9wLaM5VlJ9EAcdjWW', 0, 'mzusnahgexibkztyfpowvrjcldq', ''),
(30, 'pol', 'pol', 'pol', 'pol@gmail.com', 'boÍãl ½_=]6Ç(ƒÇ…ãÀ0zlx2æ', 0, 'uogbnidyrvpzkjlqtzfwemcxsha', '');
